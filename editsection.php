...
{
$id=$_REQUEST['id'];
$bscrim =$_REQUEST['bscrim'];
$bsinfotech =$_REQUEST['bsinfotech'];
$bsed =$_REQUEST['bsed'];
$bshm =$_REQUEST['bshm'];
$bsindustech =$_REQUEST['bsindustech'];
$btvted =$_REQUEST['btvted'];
$update="update section set  bscrim='".$bscrim."', bsinfotech='".$bsinfotech."', bsed='".$bsed."', bshm='".$bshm."', bsindustech='".$bsindustech."', btvted='".$btvted."' where id='".$id."'";
mysqli_query($con, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br><a href='viewsection.php'>View Updated Record</a>";
...
<center><h2><font face="Times New Roman" color="yellow"><b>Update Section Record</b></font></h2>
<form name="form" method="post" action=""> 
<input type="hidden" name="new" value="1" />
<input name="id" type="hidden" value="<?php echo $row['id'];?>" />
<p><input type="text" name="bscrim" placeholder="BSCRIM Sections" required value="<?php echo $row['bscrim'];?>" /></p>
<p><input type="text" name="bsinfotech" placeholder="BSINFO.TECH. Sections" required value="<?php echo $row['bsinfotech'];?>" /></p>
<p><input type="text" name="bsed" placeholder="BSED Sections" required value="<?php echo $row['bsed'];?>" /></p>
<p><input type="text" name="bshm" placeholder="BSHM Sections" required value="<?php echo $row['bshm'];?>" /></p>
<p><input type="text" name="bsindustech" placeholder="BSINDUS.TECH. Sections" required value="<?php echo $row['bsindustech'];?>" /></p>
<p><input type="text" name="btvted" placeholder="BTVTED Sections" required value="<?php echo $row['btvted'];?>" /></p>
