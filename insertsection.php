...
$ins_query="insert into section (`bscrim`, `bsinfotech`, `bsed`, `bshm`, `bsindustech`, `btvted` ) values ('$bscrim', '$bsinfotech', '$bsed', '$bshm', '$bsindustech', '$btvted')";

mysqli_query($con,$ins_query) or die(mysql_error());
$status = "New Record Inserted Successfully.</br></br><a href='viewsection.php'>View Inserted Record</a>";
}
?>
...
INSERT SECTION</font></h1><br><br><br>
</center>
</div>
    </center>
...
<p><input type="text" name="bscrim" placeholder="BSCRIM Sections" required /></p>
<p><input type="text" name="bsinfotech" placeholder="BSINFO.TECH. Sections" required /></p><br>
<p><input type="text" name="bsed" placeholder="BSED Sections" required /></p><br>
<p><input type="text" name="bshm" placeholder="BSHM Sections" required /></p><br>
<p><input type="text" name="bsindustech" placeholder="BSINDUS.TECH. Sections" required /></p><br>
<p><input type="text" name="btvted" placeholder="BTVTED Sections" required /></p><br>
