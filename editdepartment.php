...
$update="update department set  departments='".$departments."' where id='".$id."'";
mysqli_query($con, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br><a href='viewdepartment.php'>View Updated Record</a>";
...
<center><h2><font face="Times New Roman" color="yellow"><b>Update Department Record</b></font></h2>
<form name="form" method="post" action=""> 
<input type="hidden" name="new" value="1" />
<input name="id" type="hidden" value="<?php echo $row['id'];?>" />
<p><input type="text" name="departments" placeholder="Enter Department" required value="<?php echo $row['departments'];?>" /></p>
