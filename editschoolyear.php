...
$id = $_REQUEST['id'];
$query = "SELECT * from schoolyr where id ='".$id."'"; 
...
$update="update schoolyr set  schoolyear='".$schoolyear."' where id='".$id."'";
mysqli_query($con, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br><a href='viewschoolyear.php'>View Updated Record</a>";
...
<center><h2><font face="Times New Roman" color="yellow"><b>Update Scool Year Record</b></font></h2>
<form name="form" method="post" action=""> 
<input type="hidden" name="new" value="1" />
<input name="id" type="hidden" value="<?php echo $row['id'];?>" />
<p><input type="text" name="schoolyear" placeholder="Enter School Year" required value="<?php echo $row['schoolyear'];?>" /></p>
