...
$id = $_REQUEST['id'];
$query = "SELECT * from yearlevel where id ='".$id."'"; 
...
$update="update yearlevel set  yrlvl='".$yrlvl."' where id='".$id."'";
mysqli_query($con, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br><a href='viewyrlvl.php'>View Updated Record</a>";
...
<center><h2><font face="Times New Roman" color="yellow"><b>Update Year Level Record</b></font></h2>
<form name="form" method="post" action=""> 
<input type="hidden" name="new" value="1" />
<input name="id" type="hidden" value="<?php echo $row['id'];?>" />
<p><input type="text" name="yrlvl" placeholder="Enter Year Level" required value="<?php echo $row['yrlvl'];?>" /></p>
