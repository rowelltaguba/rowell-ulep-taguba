...
$ins_query="insert into department (`departments`) values ('$departments')";
mysqli_query($con,$ins_query) or die(mysql_error());
$status = "New Record Inserted Successfully.</br></br><a href='viewdepartment.php'>View Inserted Record</a>";
}
?>
...
INSERT DEPARTMENT</font></h1><br><br><br>
</center>
</div>
    </center>
...
<p><input type="text" name="departments" placeholder="Insert Department" required /></p>
