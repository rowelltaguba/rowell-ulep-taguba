...
$ins_query="insert into semester (`semesters`) values ('$semesters')";
mysqli_query($con,$ins_query) or die(mysql_error());
$status = "New Record Inserted Successfully.</br></br><a href='viewsemester.php'>View Inserted Record</a>";
}
?>
...
INSERT SEMESTER</font></h1><br><br><br>
</center>
</div>
    </center>
...
<p><input type="text" name="semesters" placeholder="Insert Semester" required /></p>
