...
<!--Chart-box-->    
    <div class="row-fluid">
      <a href="insertcourse.php"><input name="submit" type="submit" value="ADD" /></a>
<center><h2><font face="Times New Roman" color="green"><b>ISU - A COURSES</b></font></h2></center>
<div class="table">
<table width="100%" border="1" style="border-collapse:collapse;">
<thead>
<tr>
<th><strong><font face="Times New Roman" color="red">COURSE No.</font></strong></th>
...
<?php
$count=1;
$sel_query="Select * from course ORDER BY id desc;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center"><?php echo $count; ?>
</td><td align="center"><?php echo $row["courses"]; ?></td>
<td align="center"><a href="editcourse.php?id=<?php echo $row["id"]; ?>">Edit</a></td>
<td align="center"><a href="deletecourse.php?id=<?php echo $row["id"]; ?>">Delete</a></td></tr>
<?php $count++; } ?>
</tbody>
</table>
</div>
