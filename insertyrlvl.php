...
$ins_query="insert into yearlevel (`yrlvl`) values ('$yrlvl')";
mysqli_query($con,$ins_query) or die(mysql_error());
$status = "New Record Inserted Successfully.</br></br><a href='viewyrlvl.php'>View Inserted Record</a>";
}
?>
...
INSERT YEAR LEVEL</font></h1><br><br><br>
</center>
</div>
    </center>
...
<p><input type="text" name="yrlvl" placeholder="Insert Year Level" required /></p>
