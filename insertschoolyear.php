...
$ins_query="insert into schoolyr (`schoolyear`) values ('$schoolyear')";
mysqli_query($con,$ins_query) or die(mysql_error());
$status = "New Record Inserted Successfully.</br></br><a href='viewschoolyear.php'>View Inserted Record</a>";
}
?>
...
INSERT SCHOOL YEAR</font></h1><br><br><br>
</center>
</div>
    </center>
...
<p><input type="text" name="schoolyear" placeholder="Insert School Year" required /></p>
