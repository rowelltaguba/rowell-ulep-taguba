  ...
  session_start();
    ...
    $rows = mysqli_num_rows($result);
      ...
      header("Location: adminindex.php");
        ...
        echo "<div class='form'><h3>Username/password is incorrect.</h3><br/>Click here to <a href='login.php'><font color=yellow>Login</font></a></div>";
        }
    }else{
?>
...
<input name="submit" type="submit" value="Login" /><p></p><a href='userlogin.php'><font color=yellow>Student Login</font></a><br>
