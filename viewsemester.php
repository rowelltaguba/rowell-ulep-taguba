...
<!--Chart-box-->    
    <div class="row-fluid">
      <a href="insertsemester.php"><input name="submit" type="submit" value="ADD" /></a>
<center><h2><font face="Times New Roman" color="green"><b>ISU - A SEMESTERS</b></font></h2></center>
<div class="table">
<table width="100%" border="1" style="border-collapse:collapse;">
<thead>
<tr>
<th><strong><font face="Times New Roman" color="red">SEMESTER No.</font></strong></th>
<th><strong><font face="Times New Roman" color="red">SEMESTERS</font></strong></th>
...
<?php
$count=1;
$sel_query="Select * from semester ORDER BY id desc;";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center"><?php echo $count; ?>
</td><td align="center"><?php echo $row["semesters"]; ?></td>
<td align="center"><a href="editsemester.php?id=<?php echo $row["id"]; ?>">Edit</a></td>
<td align="center"><a href="deletesemester.php?id=<?php echo $row["id"]; ?>">Delete</a></td></tr>
<?php $count++; } ?>
</tbody>
</table>
</div>
