...
$update="update course set  courses='".$courses."' where id='".$id."'";
mysqli_query($con, $update) or die(mysqli_error());
$status = "Record Updated Successfully. </br></br><a href='viewcourse.php'>View Updated Record</a>";
...
<center><h2><font face="Times New Roman" color="yellow"><b>Update Course Record</b></font></h2>
<form name="form" method="post" action=""> 
<input type="hidden" name="new" value="1" />
<input name="id" type="hidden" value="<?php echo $row['id'];?>" />
<p><input type="text" name="courses" placeholder="Enter Course" required value="<?php echo $row['courses'];?>" /></p>
